...
theme.cf_appswitcher = { font = "Play", size = 12, face = 1 } -- application switcher font
theme.cf_monitor     = { font = "Play", size = 10, face = 1 } -- monitoring widget font

-- environment vars
theme.panel_height        = 35 -- panel height
theme.border_width        = 2  -- window border width
theme.useless_gap_width   = 10 -- Lain useless gap
...
theme.desktop.grid2 = {
  width  = { 520, 520, 520 },
  height = { 180, 180, 180, 60 },
  edge   = { width = { 1980, 1980 }, height = { 60, 60 } }
}
...
theme.float.dfparser.icons = {
  df_icon       = "~/.icons/ACYLS/scalable/mimetypes/application-x-executable.svg",
  theme         = "~/.icons/ACYLS",
	custom_only   = false,
	scalable_only = false
}
