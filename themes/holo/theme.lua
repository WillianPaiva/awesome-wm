...
theme.layouts                      = os.getenv("HOME") .. "/.config/awesome/themes/layouts"
...
theme.taglist_font                  = "Source Code Pro 13"
theme.fg_normal                     = "#009688"
...
theme.layout_uselesstile            = theme.layouts .. "/tile.svg"
theme.layout_uselessfair        = theme.layouts .. "/fair.svg"
theme.layout_magnifier         = theme.layouts .. "/max.svg"
theme.layout_floating         = theme.layouts .. "/floating.svg"
theme.layout_usermap         = theme.layouts .. "/map.svg"
